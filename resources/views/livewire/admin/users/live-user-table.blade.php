                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm ">
                            <div class="">
                                <a href="javascript:void(0)" wire:click="showModal({{ $user->id }})" type="button" class=" justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700
