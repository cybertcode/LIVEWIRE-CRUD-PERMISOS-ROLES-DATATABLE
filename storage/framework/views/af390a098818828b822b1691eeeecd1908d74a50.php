...
} elseif ($_instance->childHasBeenRendered('ksMTETj')) {
    $componentId = $_instance->getRenderedChildComponentId('ksMTETj');
    $componentTag = $_instance->getRenderedChildComponentTagName('ksMTETj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ksMTETj');
} else {
    $response = \Livewire\Livewire::mount('admin.users.live-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('ksMTETj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php $__env->stopPush(); ?>
