...
} elseif ($_instance->childHasBeenRendered('JVRoLxk')) {
    $componentId = $_instance->getRenderedChildComponentId('JVRoLxk');
    $componentTag = $_instance->getRenderedChildComponentTagName('JVRoLxk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JVRoLxk');
} else {
    $response = \Livewire\Livewire::mount('admin.users.live-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('JVRoLxk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php $__env->stopPush(); ?>
