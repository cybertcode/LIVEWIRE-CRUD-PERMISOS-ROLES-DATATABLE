...
} elseif ($_instance->childHasBeenRendered('bBqlAfu')) {
    $componentId = $_instance->getRenderedChildComponentId('bBqlAfu');
    $componentTag = $_instance->getRenderedChildComponentTagName('bBqlAfu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bBqlAfu');
} else {
    $response = \Livewire\Livewire::mount('admin.users.live-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('bBqlAfu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php $__env->stopPush(); ?>
